...
token = os.getenv("GH_TOKEN")
if not token:
    raise Exception("❌ GitHub token not found. Set GH_TOKEN in .env or GitHub Secrets.")
...
# -------- 3. Profile Summary (Manual Stats) --------
summary_labels = ["Contributions", "Repos", "Current Streak", "Longest Streak", "Profile Views"]
summary_values = [1298, user.public_repos, 12, 45, 762]  # Update dynamically if needed
